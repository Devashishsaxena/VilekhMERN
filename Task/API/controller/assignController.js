...
export const fetch=async (req,res)=>{
  ...
  export const updateProject=async(req,res,next)=>{
    ...
    if(projectDetails){
       let project=await ProjectSchemaModel.updateOne(JSON.parse(req.body.condition_obj),{$set: JSON.parse(req.body.content_obj)});   
       if(project)
